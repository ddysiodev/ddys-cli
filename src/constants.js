...
export const COMMAND_GROUPS = {
  read: ['search', 'suggest', 'latest', 'hot', 'movies', 'movie', 'sources', 'related', 'comments', 'calendar', 'types', 'genres', 'regions', 'collections', 'collection', 'shares', 'share', 'requests', 'activities', 'user', 'me'],
